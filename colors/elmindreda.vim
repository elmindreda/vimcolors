...
hi IncSearch    guifg=#ffffff  guibg=#000000  ctermfg=white      ctermbg=black          gui=none  cterm=none
hi MatchParen   guifg=#ffffff  guibg=bg       ctermfg=white      ctermbg=bg             gui=bold  cterm=bold

hi SpecialKey   guifg=#00ffff                 ctermfg=cyan                              gui=none  cterm=none
hi Directory    guifg=#00ffff                 ctermfg=cyan                              gui=none  cterm=none
hi Title        guifg=#ffff00                 ctermfg=yellow                            gui=none  cterm=none
hi ErrorMsg     guifg=#ffffff  guibg=#ff0000  ctermfg=white      ctermbg=red            gui=none  cterm=none
hi WarningMsg   guifg=#ff0000                 ctermfg=red                               gui=none  cterm=none
hi WildMenu     guifg=#ffffff  guibg=#000000  ctermfg=white      ctermbg=black          gui=none  cterm=none
hi ModeMsg      guifg=#00ff00                 ctermfg=green                             gui=none  cterm=none
hi MoreMsg      guifg=#00ff00                 ctermfg=green                             gui=none  cterm=none
...
" Splitter colors
hi StatusLine       guifg=#000000  guibg=#ffffff  ctermfg=black  ctermbg=white          gui=bold  cterm=bold
hi StatusLineNC     guifg=#000000  guibg=#808080  ctermfg=black  ctermbg=gray           gui=bold  cterm=bold
hi StatusLineTerm   guifg=#000000  guibg=#80ff80  ctermfg=black  ctermbg=lightgreen     gui=bold  cterm=bold
hi StatusLineTermNC guifg=#000000  guibg=#808080  ctermfg=black  ctermbg=lightgreen     gui=bold  cterm=bold
hi VertSplit        guifg=#ffffff  guibg=#808080  ctermfg=black  ctermbg=darkgray       gui=bold  cterm=bold
...
hi LineNr       guifg=#ffffff                 ctermfg=white                             gui=none  cterm=none
...
hi lCursor      guifg=#ffffff  guibg=#000000  ctermfg=white      ctermbg=black          gui=none  cterm=none

" Code colors
hi Comment      guifg=#c0c0c0  guibg=bg       ctermfg=grey       ctermbg=bg             gui=none  cterm=none
hi Constant     guifg=#00ffff  guibg=bg       ctermfg=lightcyan                         gui=none  cterm=none
hi Special      guifg=#ffffff  guibg=bg       ctermfg=white                             gui=none  cterm=none
hi Identifier   guifg=#ffff00  guibg=bg       ctermfg=yellow                            gui=none  cterm=none
hi Statement    guifg=#ffffff  guibg=bg       ctermfg=white                             gui=none  cterm=none
hi PreProc      guifg=#ffffff  guibg=bg       ctermfg=white                             gui=none  cterm=none
hi Type         guifg=#ffffff  guibg=bg       ctermfg=white                             gui=none  cterm=none
